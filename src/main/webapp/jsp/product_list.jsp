...
<c:if test="${not empty pb.list}">
    <c:forEach items="${pb.list}" var="product">
			<div class="col-md-2">
				<a href="/product?method=findBypid&pid=${product.pid}">
				...
				<p><font color="#FF0000">${product.shop_price}</font></p>
			</div></c:forEach>
</c:if>
		...
		<div style="width:380px;margin:0 auto;margin-top:50px;">
			<ul class="pagination" style="text-align:center; margin-top:10px;">
                ...
                <c:if test="${pb.pageNumber!=pb.totalPage}">
                    <li>
                        <a href="/product?method=findProduct&cid=${cid}&pageNumber=${pb.pageNumber+1}" aria-label="Next">
                            <span aria-hidden="true">&raquo;</span>
                        </a>
                    </li>
                </c:if>
